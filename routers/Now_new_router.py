...
file_path = 'tool/now_news.jsonl'


@now_router.post(schedule_path, response_model=BaseResponse)
def web_scraper_nownews(request_key: str, keyword: str, start_date: int = start, end_date: int = start):
